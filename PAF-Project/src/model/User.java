...
public class User {
	...
	{
	output = "Error while creating user profile.";
	...
	// buttons
	//output += "<td><input name='btnUpdate' type='button' value='Update'class='btn btn-secondary'></td>" + "<td><form method='post' action='items.jsp'>" + "<input name='btnRemove' type='submit' value='Remove' class='btn btn-danger'>" + "<input name='NIC' type='hidden' value='" + NIC + "'>" + "</form></td></tr>";
	}
	con.close();
	...
	public String insertUser(String nIC, String name, String type, int phone, String email, String address,
			String history) {
