...
{
 String output = productObj.insertProduct(productID,productCode, productName, productPrice, productDes);
return output;
}
...
//Read the values from the JSON object
 ...
 String output = productObj.updateProduct(productID, productCode, productName, productPrice, productDes);
return output;
}
